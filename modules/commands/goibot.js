...
module.exports.handleEvent = function({ api, event }) {
  ...
  var tl = ["Bố đây😒", "Gọi con cặc🖕", "Đầu buồi gì🥲", "Anh đây em😤",  "Đi nhà nghỉ thì hẵng gọi tao🥵", "Yêu anh Hoàng không mà gọi❓️", "Gọi cái lồn gì mà gọi lắm 😠", "Gọi gì vậy em yêu 😘", "Địt mẹ lại gọi gì bố🤬", "Ơi tao đây😵‍💫", "Gọi ít thôi địt mẹ mày ạ🆑️", "Sủa đi em🙄", "Chỉ anh Hoàng mới được gọi tao ok🖕🤬"];
